...
import com.tts2.h2explorer.repository.CustomerRepository;

@SpringBootApplication
public class H2explorerApplication {
	private static final Logger log = LoggerFactory.getLogger(H2explorerApplication.class);

	public static void main(String[] args) {
		SpringApplication.run(H2explorerApplication.class, args);
	}
